...
/**
 * BaseTemplateController extends CompositeController adding code to track sources
 * and the framework for processing and using templates
 *
 * Processing of templates is implemented in subclasses of the BaseTemplateController
 */
...
module.exports = class BaseTemplateController extends CompositeController {
  ...
  async added() {
    ...
    this.log.debug(`${this.selfLink} rendered templates: '${JSON.stringify(templates)}'`);
