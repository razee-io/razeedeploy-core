...
module.exports = class BaseController {
  constructor(params) {
    ...
    this._selfLink = this._kubeResourceMeta.uri({
      name: objectPath.get(this._data, 'object.metadata.name'),
      namespace: objectPath.get(this._data, 'object.metadata.namespace')
    });
    objectPath.set(this._data, 'object.metadata.annotations.selfLink', this._selfLink);
