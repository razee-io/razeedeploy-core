...
module.exports = class BaseController {
  ...
  async _added() {
    ...
    let res = await this.patchSelf({ metadata: { annotations: { 'deploy.razee.io/data-hash': this._computeDataHash(objectPath.get(this._data, 'object')) } } });
  ...
  _computeDataHash(resource) {
    let importantData = this.computeDataHash(resource);
