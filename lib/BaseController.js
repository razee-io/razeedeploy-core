...
module.exports = class BaseController {
  ...
  async _added() {
    ...
    this._logger.debug(`Finalizer ${selfLink}: deletionTimestamp ${deletionTimestamp}`);
  ...
  async finalizer() {
    ...
    if (hasDeletionTimestamp) {
      ...
      if (finalizerIndex > -1) {
        ...
        // if patch to remove finalizer fails (will fail if resourceVersion has changed), this will reject out and should try again next cycle.
      }
