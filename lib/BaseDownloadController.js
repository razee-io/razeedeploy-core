...
module.exports = class BaseDownloadController extends CompositeController {
  ...
  async added() {
      ...
      try {
        ...
        if (res.statusCode >= 200 && res.statusCode < 300) {
          ...
          if (resLM) {
            ...
            lastModifiedArray.push({ hash: requestHash, url: url, 'last-modified': resLM });
          }
    ...
    this.updateStatus({ path: ['last-modified'], status: lastModifiedArray });
